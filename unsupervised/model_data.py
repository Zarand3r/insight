...
nuclear_data = pd.read_csv("test_simple.csv")
...
colors = nuclear_data['AreaShape_MeanRadius']
...
# 		colors.append("cyan")
# 	elif label == "Acute Scar":
# 		colors.append("red")
# 	elif label == "Subacute Scar":
# 		colors.append("orange")
# 	elif label == "Unscarred":
# 		colors.append("blue")

#Intensity_MaxIntensity_Enhanced_Inverted  #AreaShape_Area  #Intensity_MeanIntensity_Enhanced_Inverted
...
#################
h = plt.figure(2)
plt.scatter(pca_results[:,0],pca_results[:,1],c = colors,s=3)  #,c = y  #,pca_results[:,2]
plt.title("PCA")

g = plt.figure(3)
plt.scatter(tsne_results[:,0],tsne_results[:,1],c = colors,s=3)  #,c = y
plt.title("tSNE")
plt.show()
